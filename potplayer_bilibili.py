...
headers = """origin: https://live.bilibili.com""".replace('\n','\\n')
...
if __name__ == '__main__':
    ...
    if len(result) > 0:
        url = result[list(result)[0]]
        command = f'"C:\Program Files\DAUM\PotPlayer\PotPlayerMini64.exe" "{url}" /user_agent="{ua}" /referer="https://live.bilibili.com/{r}"'
        print(command)
